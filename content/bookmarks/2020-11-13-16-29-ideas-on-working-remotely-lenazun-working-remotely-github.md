...
Working remotely sounds _great_. We think we’ll save ourselves the commute and we’ll be able to flexibly weave in and out of work and home life. In reality, work takes a different shape when there is no office, and we’re all in different environments trying to connect to other humans.
...
Feel free to share this content under [a CC license](https://creativecommons.org/licenses/by-sa/4.0/). **Send a pull request with your edits and ideas!**

These are some of the things we’ve learned while working remotely:

[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#before-you-get-hired-some-questions-to-ask)Before you get hired (some questions to ask)
-----------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#communication)Communication
-----------------------------------------------------------------------------------------------
...
*   **Asking questions.** The earlier you ask a question, the happier we’ll all be. Don’t struggle with a problem or a doubt by yourself, [just ask someone](http://rckbt.me/2016/03/help/). It doesn’t matter if they look busy (remember, it’s their job to manage their own time). [Ask detailed questions](http://stackoverflow.com/help/how-to-ask) and give indications of the type of answer you’re looking for (an idea, step by step instructions, help troubleshooting, debugging, testing something out, etc)
...
[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#decision-making)Decision making
---------------------------------------------------------------------------------------------------
...
*   **Decisions should be communicated via email.** When a decision is made, communicate it clearly as a _decision_ via email, with clear next steps. Technical decisions have [their own documents](http://h.readthedocs.io/en/latest/arch/) ([ADRs](http://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions)). Do not assume Slack is a good record for decisions or a good way to assign responsibilities. Work is assigned on cards on a sprint, github issues, in a face to face conversation, or via email.
...
[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#leadership-and-group-dynamics)Leadership and group dynamics
-------------------------------------------------------------------------------------------------------------------------------
...
[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#logistics)Logistics
---------------------------------------------------------------------------------------
...
[](https://github.com/lenazun/working-remotely/blob/master/ideas.md#health-family-and-the-real-world)Health, family and the real world
--------------------------------------------------------------------------------------------------------------------------------------
...
*   **Avoid burn-out.** [Learn to recognize burn-out](http://www.catehuston.com/blog/2014/04/23/the-burnout-equation/) and how to avoid it. We want you to be a happy, productive person for a long time. If you recognize the signs of burn-out on a teammate, reach out and ask how they’re doing.
